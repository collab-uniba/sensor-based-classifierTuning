...
getFeatures_HR_baseline <- function(baseline_values) {
  HR_mean_baseline <- mean(baseline_values)
  HR_variance_baseline <- var(baseline_values)

  HR_features_baseline <- c(HR_mean_baseline, HR_variance_baseline)
  return(HR_features_baseline)
}
