...
getFeatures_EDA<-function(baseline_values, interval_values){
  ...
  print("EDA normalized")
  print(length(EDA_normalized))
  EDA_preprocessed <- EDA_preprocessing(EDA_normalized)
  print("*EDA preprocessed*")
  
  print(length(EDA_preprocessed$phasic))
  print(EDA_preprocessed$phasic)
  print(length(EDA_preprocessed$tonic))
  print(EDA_preprocessed$tonic)
...
getFeatures_EDA_baseline<-function(baseline_values) {
  print("EDA baseline")
  EDA_preprocessed <- EDA_preprocessing(baseline_values)
  print("*EDA baseline preprocessed*")
  print(length(EDA_preprocessed$phasic))
  print(EDA_preprocessed$phasic)
  print(length(EDA_preprocessed$tonic))
  print(EDA_preprocessed$tonic)
  ...
  mean_phasic_peak <- getMeanOfPhasicPeaks(SkinConductivityResponse$amplitudes)
  sum_phasic_peak_amplitude <- getSumOfPhasicPeakAmplitude(SkinConductivityResponse$amplitudes)
  EDA_features_baseline <- c(mean_SCL, AUC_Phasic, min_peak_amplitude, max_peak_amplitude, mean_phasic_peak, sum_phasic_peak_amplitude )
  return(EDA_features_baseline)
}
